"""
Django settings for citizen_feedback_system project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-p1vpi02n41yd1g5g4s51$81k=_)42q47wjkrscq1+pci_#ydj@')
...
ALLOWED_HOSTS = [
    ...
    "citizen-feedback-system-8.onrender.com",
    ".onrender.com",
    "localhost",
    "127.0.0.1"
]
...
ROOT_URLCONF = 'citizen_feedback_system.urls'
...
WSGI_APPLICATION = 'citizen_feedback_system.wsgi.application'
